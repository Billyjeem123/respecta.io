...
if (isset($data->apptoken)) {
	...
	if ($Auth->CheckToken($apptoken)==true) {
        ...
        if ($tribute->createComment($data->usertoken, $data->theOwner, $data->postid, 
        $data->comment, $data->filename, $data->filetype) == true) {

            echo $Utility->outputData(true, "Comment sent..", null);
            exit();
        } else {
